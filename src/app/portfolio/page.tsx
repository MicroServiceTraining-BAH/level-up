    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "LevelUp Local Portfolio - Web Design for Local Businesses",
      },
    ],
  },
  twitter: {
    ...
    <>
      ...
      <section className="relative bg-brand-bg pt-36 pb-24 overflow-hidden">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 70% 40%, rgba(0,194,255,0.07) 0%, transparent 60%)",
          }}
        />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          <AnimateIn className="max-w-3xl">
            ...
            <p className="text-xl text-brand-muted leading-[1.75] max-w-2xl">
              Here&apos;s a look at example websites we build for local service
              businesses - clean, professional, and built to convert visitors
              into customers.
            </p>
          </AnimateIn>
        </div>
              ...
              >
                ...
                <div className="relative">
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(to top, rgba(9,9,15,0.7) 0%, rgba(9,9,15,0.15) 50%, transparent 100%)",
                    }}
                  />
                  {/* Color treatment */}
                  <div
                ...
                <div className="bg-brand-elevated p-8 md:p-10">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                      ...
                      <h2 className="font-heading font-black text-2xl md:text-3xl text-brand-text mb-3 tracking-tight">
                        {project.name}
                      </h2>
      ...
      <section className="relative bg-brand-bg py-24 overflow-hidden">
        ...
        <AnimateIn className="relative z-10 max-w-2xl mx-auto px-6 text-center">
          ...
          <h2 className="font-heading font-black text-4xl md:text-5xl leading-[1.06] tracking-[-0.01em] text-brand-text mb-6">
            Want a Website Like This for{" "}
            <span className="text-brand-blue">Your Business?</span>
          </h2>
          <p className="text-brand-muted text-lg leading-[1.75] mb-10">
            Book a free 15-minute audit call. We&apos;ll talk about your
            business and show you exactly what your website would look like.
          </p>
          <Link
            href="/booking"
