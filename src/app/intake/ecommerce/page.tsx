...
import { ECOMMERCE_SECTIONS } from "@/lib/ecommerce-intake-sections";
      ...
      <section className="min-h-screen py-16 px-4">
        <div className="max-w-[920px] mx-auto">
          ...
          <div className="rounded-2xl border border-[#252535] bg-[#111118] p-6 sm:p-8">
            <IntakeForm sections={ECOMMERCE_SECTIONS} />
          </div>
        </div>
      </section>
    );
    ...
    <section className="min-h-screen flex items-center justify-center px-4 py-16">
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          <p className="text-xs font-semibold tracking-widest uppercase text-[#00C2FF] mb-3">
            LvL Up Local
          </p>
          ...
          <p className="text-sm text-[#70708A] leading-relaxed">
            Enter your access code to continue to the store intake form.
          </p>
        </div>
        ...
        <form onSubmit={handleUnlock} noValidate>
          <div className="mb-4">
            <label
              htmlFor="access-code"
              className="block text-sm font-medium text-[#F0F0FF] mb-2"
            >
              Access code
            </label>
            <input
