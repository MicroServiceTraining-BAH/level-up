    ...
    <>
      ...
      <section className="relative bg-brand-bg pt-36 pb-16 overflow-hidden">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 60% 40%, rgba(0,194,255,0.07) 0%, transparent 55%)",
          }}
        />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          <AnimateIn className="max-w-2xl">
            ...
            <p className="text-xl text-brand-muted leading-[1.75]">
              Have a question? Want to learn more before booking? Send us a
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
            ...
            <div className="lg:col-span-2 space-y-6">
              <AnimateIn from="left">
                ...
                >
                  <h3 className="font-heading font-bold text-brand-text text-lg mb-6">
                    Contact Info
                  </h3>
                  <div className="space-y-5">
                    <div className="flex items-center gap-4">
                      <div
                        className="w-10 h-10 rounded-xl flex items-center justify-center text-brand-blue flex-shrink-0"
                        style={{
                      ...
                      <div>
                        <p className="text-brand-muted text-xs uppercase tracking-wider mb-0.5">
                          Email
                        </p>
                        <a
                ...
                <div
                  className="p-7 rounded-2xl bg-brand-elevated border border-brand-blue/20"
                  style={{
                ...
                >
                  ...
                  <p className="text-brand-muted text-sm leading-[1.7] mb-5">
                    Skip the back-and-forth. Book a time directly and we&apos;ll
            ...
            <div className="lg:col-span-3">
              <AnimateIn from="right">
                <div
                  className="p-8 md:p-10 rounded-3xl bg-brand-elevated border border-brand-border"
                  style={{ boxShadow: "0 8px 40px rgba(0,0,0,0.35)" }}
                >
                  <h2 className="font-heading font-bold text-brand-text text-2xl mb-2">
                    Send a Message
                  </h2>
