...
export const metadata: Metadata = {
  title: "Local SEO Services in Fairfax, VA | LevelUp Local",
  description:
    "Local SEO and web design for small businesses in Fairfax, VA. Rank on Google, get more local customers, and grow. Free SEO audit from LevelUp Local.",
  alternates: {
