...
export const metadata: Metadata = {
  title: "Local SEO Services in Manassas, VA | LevelUp Local",
  description:
    "Professional local SEO and web design for small businesses in Manassas, VA. Get more customers from Google — free audit from LevelUp Local today.",
  alternates: {
