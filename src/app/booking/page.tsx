    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Book a Free Website Audit - LevelUp Local",
      },
    ],
  },
  twitter: {
...
const whatToExpect = [
  {
    title: "15 minutes",
    desc: "Quick, focused, no fluff. We respect your time.",
  },
  {
    title: "No sales pressure",
    desc: "It's a real conversation about your business, not a pitch.",
  },
  {
    title: "Actionable insight",
    desc: "You'll leave knowing exactly what your business needs online.",
  },
  {
    title: "Custom plan",
    desc: "We'll outline what we'd build for your specific business.",
  },
];
    ...
    <>
      ...
      <section className="relative bg-brand-bg pt-36 pb-16 overflow-hidden">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 50% 30%, rgba(0,194,255,0.08) 0%, transparent 55%)",
          }}
        />
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <AnimateIn>
            ...
            <h1 className="font-heading font-black text-5xl md:text-6xl lg:text-[68px] leading-[1.03] tracking-[-0.01em] text-brand-text mb-6">
              Book Your Free{" "}
              <span className="text-brand-blue">Website Audit</span>
            </h1>
            <p className="text-xl text-brand-muted leading-[1.75] max-w-xl mx-auto">
              A free 15-minute call to understand your business and map out how
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
              ...
              <AnimateIn from="left">
                ...
                <div className="space-y-5 mb-10">
                  {whatToExpect.map((item, i) => (
                    <div
                      key={item.title}
                      className="flex gap-4 p-5 rounded-xl bg-brand-elevated border border-brand-border"
                    >
                      <div
                        className="w-8 h-8 rounded-lg flex items-center justify-center font-heading font-black text-sm flex-shrink-0 text-brand-blue"
                        style={{
                      ...
                      <div>
                        <div className="font-semibold text-brand-text text-sm mb-1">
                          {item.title}
                        </div>
                        <div className="text-brand-muted text-xs leading-[1.7]">
                          {item.desc}
                        </div>
                      </div>
                    </div>
                ...
                >
                  ...
                  <p className="text-brand-muted text-sm leading-[1.7]">
                    ...
                    to ensure quality. If you&apos;re interested, don&apos;t
                    wait.
                  </p>
                </div>
              </AnimateIn>
            ...
            <div className="lg:col-span-3">
              <AnimateIn from="right">
                <div
                  className="rounded-3xl bg-brand-elevated border border-brand-border overflow-hidden"
                  style={{ boxShadow: "0 8px 40px rgba(0,0,0,0.4)" }}
                >
                  {/* Calendly inline embed placeholder */}
                  <div className="p-8 border-b border-brand-border">
                    <h3 className="font-heading font-bold text-brand-text text-xl mb-1">
                      Schedule Your Call
                    </h3>
                    <p className="text-brand-muted text-sm">
                      Pick a time that works for you - we&apos;ll confirm right
                      away.
                    </p>
                  </div>
                  ...
                  <noscript>
                    <div className="p-10 text-center">
                      <p className="text-brand-muted text-sm mb-4">
                        Please enable JavaScript to use the scheduling widget.
                      </p>
                      <a
                        href="mailto:sales@lvluplocal.co"
